...
import numpy as np
import utils
from utils.utils import load_quadruples,get_true_distributions
...
class DistData(data.Dataset):
      def __init__(self, path, dataset, num_nodes, num_rels,set_name):
            data, times = load_quadruples(path + dataset, set_name + '.txt')
            true_prob_r = get_true_distributions(path, data, num_nodes, num_rels, dataset, set_name)
      ...
      def __getitem__(self, index):
            return self.times[index], self.true_prob_r[index], self.data[index]
